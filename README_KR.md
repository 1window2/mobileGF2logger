...
- 명단 CSV를 가져오기 전에 영향을 미리 보여 주고, 실행 취소용 1단계 자동 체크포인트를 보관합니다.
...
mobileGF2logger는 Windows 클라이언트용 GF2 로거인 [gfl2logger](https://github.com/blead/gfl2logger)에서 영감을 받은, Android 기기 내 서클 관리에 맞춘 독립적인 구현입니다.
