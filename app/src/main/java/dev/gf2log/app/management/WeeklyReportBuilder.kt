...
object WeeklyReportBuilder {
    ...
    fun build(
        ...
        val isGunsmoke = PlatoonPeriods.isGunsmokeWeek(referenceDay)
        val start = if (isGunsmoke) {
            PlatoonPeriods.gunsmokeWeekStart(referenceDay)
        } else {
            PlatoonPeriods.meritWeekStart(referenceDay)
        }
